...
const populerSource = await readFile(populerHtml, "utf8");
if (!/Kata paling sering dipakai/u.test(populerSource) || !/\/kata\//u.test(populerSource))
  throw new Error("Popular words page is missing its ranking content");
